...
class SUNETx4(NIC_Architecture):
    def __init__(self, in_ch=5, out_ch=2, nfilts=32, ndims=3, do_softmax_in_train=True, dropout_rate=0.2):
        ...
        self.do_softmax_in_training = do_softmax_in_train
    ...
    def forward(self, x_in):
        ...
        if self.training:
            if self.do_softmax_in_training:
