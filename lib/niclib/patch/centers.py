...
def remove_centers_out_of_bounds(centers, patch_shape, vol_foreground):
    ...
    for n, center in enumerate(centers):
        if not(center[0] < center_range[0][0] or center[0] > center_range[0][1] or \
            center[1] < center_range[1][0] or center[1] > center_range[1][1] or \
            center[2] < center_range[2][0] or center[2] > center_range[2][1]):
                valid_centers.append(n)

    valid_centers = centers[valid_centers]
